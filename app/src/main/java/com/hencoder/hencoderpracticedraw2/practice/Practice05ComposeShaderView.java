...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        paint.setShader(new ComposeShader(new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP),
